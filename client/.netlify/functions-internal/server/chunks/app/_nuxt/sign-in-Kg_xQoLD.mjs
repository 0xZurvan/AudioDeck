    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_FormCard, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-col items-center space-y-10"${_scopeId}><h1 class="text-xl font-bold text-white"${_scopeId}>Sign in</h1><form class="flex flex-col space-y-6 w-[min(30vw)]"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "flex flex-col items-center space-y-10" }, [
                createVNode("h1", { class: "text-xl font-bold text-white" }, "Sign in"),
                createVNode("form", {
...
//# sourceMappingURL=sign-in-Kg_xQoLD.mjs.map
